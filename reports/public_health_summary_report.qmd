...
![](../docs/figures/fig5_preview.png){fig-cap="Figure 5. Age-adjusted standardized mean differences for continuous outcomes. Estimates come from linear regression models adjusted for categorical age group only and are shown in standard-deviation units." fig-alt="Forest plot of age-adjusted standardized mean differences."}
