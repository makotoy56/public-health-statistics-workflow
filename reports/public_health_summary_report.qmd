...
![](../docs/figures/fig1_preview.png){fig-cap="Figure 1. BMI distribution by sex. Crude boxplots compare the unadjusted distributions for Male and Female participants." fig-alt="Boxplot of BMI by sex."}
...
![](../docs/figures/fig2_preview.png){fig-cap="Figure 2. Blood glucose distribution by sex. Crude boxplots compare the unadjusted distributions for Male and Female participants." fig-alt="Boxplot of blood glucose by sex."}
...
![](../docs/figures/fig3_preview.png){fig-cap="Figure 3. Age-group percentages. This figure shows the composition of the analytic sample rather than a sex comparison." fig-alt="Bar chart of age-group percentages."}
...
![](../docs/figures/fig5_preview.png){fig-cap="Figure 5. Age-adjusted mean differences for continuous outcomes. Estimates come from linear regression models adjusted for categorical age group only." fig-alt="Forest plot of age-adjusted mean differences."}
...
![](../docs/figures/fig6_preview.png){fig-cap="Figure 6. Age-adjusted odds ratios for binary cutoff outcomes. Estimates come from logistic regression models adjusted for categorical age group only." fig-alt="Forest plot of age-adjusted odds ratios."}
...
![](../docs/figures/fig7_preview.png){fig-cap="Figure 7. Sex-by-age patterns for continuous outcomes. This exploratory figure shows whether mean levels appear to vary differently by sex across age groups." fig-alt="Interaction line plots for continuous outcomes."}
