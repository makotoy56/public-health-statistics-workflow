...
![](../docs/figures/fig3_preview.png){fig-cap="Figure 1. Age-Group Distribution by Sex. Bars show age-group percentages calculated separately within Male and Female participants." fig-alt="Grouped bar chart of age-group distribution by sex."}
...
![](../docs/figures/fig1_preview.png){fig-cap="Figure 2. BMI by Sex. Crude boxplots compare the unadjusted distributions for Male and Female participants." fig-alt="Boxplot of BMI by sex."}
...
![](../docs/figures/fig2_preview.png){fig-cap="Figure 3. Blood Glucose by Sex. Crude boxplots compare the unadjusted distributions for Male and Female participants." fig-alt="Boxplot of blood glucose by sex."}
...
![](../docs/figures/fig5_preview.png){fig-cap="Figure 5. Age-Adjusted Standardized Female vs Male Mean Differences. Estimates come from linear regression models adjusted for categorical age group only, shown in standard-deviation units, and sorted by absolute effect size." fig-alt="Forest plot of age-adjusted standardized Female vs Male mean differences."}
